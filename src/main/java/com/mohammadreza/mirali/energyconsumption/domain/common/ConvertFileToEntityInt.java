...
public interface ConvertFileToEntityInt {
     ...
     */
    void convertToEntity(List dtoList) throws ValidationException;
     ...
     * @throws ValidationException is the probable exception dou to our business logic
     */
    default <T> void uploadMultiPartFile(MultipartFile multipartFile, Class<T> t) throws IOException, ValidationException {
     ...
     * @throws ValidationException is the probable exception dou to our business logic
     */
    default <T> void uploadOldFile(String filePath, Class<T> t) throws IOException, ValidationException {
         ...
         */
        if(!file.delete())
            throw new IOException("File is not deleted, may be it is opened");
     ...
     * @throws ValidationException is the probable exception dou to our business logic
     */
    default <T> void uploadFile(File file, Class<T> t) throws IOException, ValidationException {
     ...
     * @throws IOException
     */
    default <T> List<T> convertFileToDto(Reader reader, Class<T> t) throws IOException {
        List<T> dtoList;
/**

...
public class ProfileFractionService implements ConvertFileToEntityInt {
     ...
     */
    @Override
    public void convertToEntity(List dtoList) throws ValidationException {
    ...
    public void deleteProfile(String profileID) throws ValidationException {
        ...
        stringBuffer.append("This profile with (").append(profileID).append(") is used in one or some Meters, first delete the meters. List of meeters : ");
        meterEntityList.forEach(meterEntity -> stringBuffer.append(meterEntity.getId()).append("; "));
    ...
    public ProfileEntity findProfileById(String profileId)
    {
        ...
        return profileEntityOptional.orElse(null);
    }
